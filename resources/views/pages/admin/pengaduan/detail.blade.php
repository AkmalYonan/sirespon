<x-app-layout>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('admin.pengaduan.index') }}" class="inline-flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-400 hover:text-white transition-smooth">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <!-- Left Column: Pengaduan Details (2 cols) -->
            ...
            <div class="space-y-6">
                ...
                <div class="glass-card rounded-3xl p-6 border border-slate-800 shadow-2xl">
                    <h3 class="text-sm font-bold uppercase tracking-wider text-slate-400 mb-4">Ubah Status Pengaduan</h3>
